...
import { Command, KlasaMessage, CommandoClient, CommandGroup } from 'discord.js-commando';
...
export default class EnableCommandCommand extends Command {
	 ...
	 * @memberof EnableCommandCommand
	 */
	public async run(msg: KlasaMessage, args: {cmdOrGrp: Command | CommandGroup}): Promise<KlasaMessage | KlasaMessage[]> {
