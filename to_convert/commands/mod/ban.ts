...
export default class BanCommand extends Command {
	 ...
	 * @memberof BanCommand
	 */
	public async run(msg: KlasaMessage, args: { member: GuildMember, reason: string, daysOfMessages: number }): Promise<KlasaMessage | KlasaMessage[]> {
	...
	private catchError(msg: KlasaMessage, args: { member: GuildMember, reason: string, daysOfMessages: number }, err: Error) {
